...
```{r}
profit_sensitivity <- profit_model(yield_results = mean_yield, price = 10)

# Plot results
p1 = ggplot(profit_sensitivity, 
            aes(temp_param2, profit, col=precip_param2)) +
  geom_point(cex=2) +
  theme_light() +
  labs(y="Profit", 
       x="Temperature Coefficient")
...
p2 = ggplot(profit_sensitivity, 
            aes(precip_param2, profit, col=temp_param2)) + 
  geom_point(cex=2) +
  theme_light() +
  labs(y="Profit", 
       x="Precipitation Coefficient")
...
```{r}
ggplot(profit_sensitivity, aes(x=profit, y=almond_yield)) +
  geom_point() +
  theme_light() +
  labs(x="Profit", 
       y="Almond Yield",
